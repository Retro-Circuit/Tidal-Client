...
public class InstanceModScreen extends TidalPanelScreen {
    ...
    protected void drawBody(GuiGraphics graphics, int mouseX, int mouseY, float delta) {
        graphics.drawString(this.font, this.entry.id() + "  " + this.entry.version(), this.bodyX, this.bodyY, Glass.MUTE, false);
        ...
        for (String line : wrap(description, 42)) {
            ...
            graphics.drawString(this.font, line, this.bodyX, y, Glass.TEXT, false);
            y += 12;
        }
        graphics.drawString(this.font, "Settings for this mod are in the mod itself.", this.bodyX, this.bodyY + this.bodyH - 14, Glass.MUTE, false);
    }
