...
public final class ExtraHuds {
    ...
    static void drawCoords(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, ExtraInfo.coords(minecraft.player), editing);
    }

    static void drawNether(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, ExtraInfo.nether(minecraft, minecraft.player), editing);
    }

    static void drawCompass(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, ExtraInfo.compass(minecraft.player), editing);
    }

    static void drawBiome(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, ExtraInfo.biome(minecraft, minecraft.player), editing);
    }

    static void drawClock(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, ExtraInfo.clock(minecraft), editing);
    }

    static void drawSpeed(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, ExtraInfo.speed(minecraft.player), editing);
    }

    static void drawMemory(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, ExtraInfo.memory(), editing);
    }

    static void drawServer(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, ExtraInfo.server(minecraft), editing);
    }

    static void drawPotions(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        drawLines(graphics, minecraft, x, y, 1.0f, ExtraInfo.potions(minecraft.player), editing);
    }

    static void drawSat(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, ExtraInfo.saturation(minecraft.player), editing);
    }

    static void drawDay(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
    ...
    private static void draw(GuiGraphicsExtractor graphics, Minecraft minecraft, int storedX, int storedY, float scale, String text, boolean editing) {
    ...
    private static void drawLines(GuiGraphicsExtractor graphics, Minecraft minecraft, int storedX, int storedY, float scale, List<String> lines, boolean editing) {
        int w = 64;
    ...
    private static void pill(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, String text, boolean editing) {
        pill(graphics, minecraft, x, y, text, editing, width(minecraft, text));
    }

    private static void pill(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, String text, boolean editing, int w) {
        int h = 16;
        if (editing) {
            Glass.roundedFill(graphics, x - 3, y - 3, x + w + 3, y + h + 3, 8, 0x330349FC);
        }
        Glass.roundedFill(graphics, x, y, x + w, y + h, 6, 0x99000000);
        graphics.centeredText(minecraft.font, text, x + w / 2, y + 4, Glass.TEXT);
    }
}
