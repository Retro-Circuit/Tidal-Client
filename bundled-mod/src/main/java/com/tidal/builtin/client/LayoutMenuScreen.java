...
public class LayoutMenuScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        graphics.text(this.font, "Layout", 36, 17, Glass.TEXT, false);
        graphics.centeredText(this.font, "Drag anywhere. Scroll while dragging to scale.", this.width / 2, 16, Glass.MUTE);
        ...
        graphics.centeredText(this.font, "Done", this.width / 2, this.height - 26, Glass.TEXT);
