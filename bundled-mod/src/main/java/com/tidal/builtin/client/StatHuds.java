...
public final class StatHuds {
    ...
    static void drawCps(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, cpsWidth(minecraft), cpsText(), editing);
    }

    static void drawFps(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
        pill(graphics, minecraft, x, y, fpsWidth(minecraft), fpsText(minecraft), editing);
    }

    static void drawCombo(GuiGraphicsExtractor graphics, Minecraft minecraft, int x, int y, boolean editing) {
